resource "aws_apigatewayv2_api" "contact" {
  name          = "contact-mailer-api"
  protocol_type = "HTTP"
  description   = "HTTP API for the ravanhani.com contact form"
...
resource "aws_cloudwatch_log_group" "api_gateway" {
  name              = "/aws/apigateway/contact-mailer"
...
resource "aws_apigatewayv2_integration" "lambda" {
  ...
  integration_uri        = aws_lambda_function.contact_mailer.invoke_arn
